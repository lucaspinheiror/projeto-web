...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.favoritos, { eager: true }),
    __metadata("design:type", user_entity_1.User)
], Favorito.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => produto_entity_1.Produto, produto => produto.favoritos, { eager: true }),
    __metadata("design:type", produto_entity_1.Produto)
], Favorito.prototype, "produto", void 0);
exports.Favorito = Favorito = __decorate([
    (0, typeorm_1.Entity)(),
    (0, typeorm_1.Unique)(['user', 'produto'])
], Favorito);
